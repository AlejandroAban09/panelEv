...
<div class="content" id="main-content">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="fw-bold text-brand">
            <span>
                <img class="img-fluid icon-light-mode" src="assets/images/supervisor-azul.png" alt="" width="35" style="margin-top: -5px;">
                <img class="img-fluid icon-dark-mode" src="assets/images/supervisor-blanco.png" alt="" width="35" style="margin-top: -5px; display: none;">
            </span>
            Supervisores
        </h2>
