                    ...
                    <tbody>
                        <?php foreach ($usuarios as $u): ?>
                            <tr>
                                ...
                                <td><?= ((int)$u->rol === 2) ? ($u->tipo_nombre ?: '-') : '-' ?></td>
                                <td>
                                    <?= ((int)$u->activo === 1)
                                ...
                                <td class="text-end">
                                    <div class="d-inline-flex gap-2">
                                        ...
                                        <button type="button"
                                            ...
                                            onclick="confirmarEliminacion(<?= $u->id ?>, '<?= addslashes($u->usuario) ?>')"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg rounded-4">
            ...
            <div class="modal-body">
                <p class="mb-0 fs-5">
                    ¿Seguro que deseas eliminar el usuario:<br>
...
<script>
    function confirmarEliminacion(id, nombre) {
        ...
        document.getElementById("btnEliminarConfirmado").href = "<?= base_url('usuarios/eliminar/') ?>" + id;
