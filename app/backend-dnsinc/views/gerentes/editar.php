<nav class="top-navbar d-flex justify-content-between align-items-center" id="top-navbar">
    ...
    <div class="fw-semibold">Gerentes | Editar</div>
                ...
                <form action="<?= $action ?>" method="post">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-7">
                            ...
                            <!-- <div class="form-text">Ingresa los 10 dígitos. El prefijo internacional +52 se agrega automático.</div> -->
                        </div>
                        <div class="col-md-5">
                            <label class="form-label fw-semibold">Estatus</label>
                            <select name="activo" class="form-select form-select-lg"> 
                                <option value="1" <?= ((int)$gerente->activo === 1 ? 'selected' : '') ?>>Activo</option>
                                <option value="0" <?= ((int)$gerente->activo === 0 ? 'selected' : '') ?>>Inactivo</option>
                            </select>
                        </div>
                    </div>
                    <div class="mb-4">
